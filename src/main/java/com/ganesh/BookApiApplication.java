...
public class BookApiApplication {
	...
	/*
	 * @Autowired private Service<Book> service;
	 */
	...
	/*
	 * @Override public void run(String... args) throws Exception { Book book = new
	 * Book(); book.setTitle("Spring Microservices in Action");
	 ...
	 * book.setLanguage("English"); service.saveOrUpdate(book); }
	 */
